...
let Dashboard = () => {
  ...
  const getProfile = async () => {
    let { status, data } = await axios.get("https://devroom-api-pt2i.onrender.com/api/profiles/me", {
      headers: {
  ...
  const getFollowerFollowingCount = async () => {
    if (profile.user) {
      const developerId = profile.user._id;
  ...
  let clickDeleteExperience = async (experienceId) => {
    const { data } = await axios.delete(`https://devroom-api-pt2i.onrender.com/api/profiles/experience/${experienceId}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
  ...
  let clickDeleteEducation = async (educationId) => {
    const { data } = await axios.delete(`https://devroom-api-pt2i.onrender.com/api/profiles/education/${educationId}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devroom")}`,
      },
                ...
                <div className="container">
                  <div className="row">
                    <div className="col">
                      ...
                      <div className="btn btn-success">Followers:{followerCount}</div>
                      <div className="btn btn-primary">Following:{followingCount}</div>
                </div>
              </section>
              {/* Experience Details */}
              <section>
